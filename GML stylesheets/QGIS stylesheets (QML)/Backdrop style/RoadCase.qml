...
<qgis version="2.16.1-Nødebo" simplifyAlgorithm="0" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="classification" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="Motorway" label="Motorway"/>
      <category render="true" symbol="1" value="Motorway, Collapsed Dual Carriageway" label="Motorway, Collapsed Dual Carriageway"/>
      <category render="true" symbol="2" value="Primary Road" label="Primary Road"/>
      <category render="true" symbol="3" value="Primary Road, Collapsed Dual Carriageway" label="Primary Road, Collapsed Dual Carriageway"/>
      <category render="true" symbol="4" value="A Road" label="A Road"/>
      <category render="true" symbol="5" value="A Road, Collapsed Dual Carriageway" label="A Road, Collapsed Dual Carriageway"/>
      <category render="true" symbol="6" value="B Road" label="B Road"/>
      <category render="true" symbol="7" value="B Road, Collapsed Dual Carriageway" label="B Road, Collapsed Dual Carriageway"/>
      <category render="true" symbol="8" value="Minor Road" label="Minor Road"/>
      <category render="true" symbol="9" value="Minor Road, Collapsed Dual Carriageway" label="Minor Road, Collapsed Dual Carriageway"/>
      <category render="true" symbol="10" value="Local Road" label="Local Road"/>
      <category render="true" symbol="11" value="Local Access Road" label="Local Access Road"/>
      <category render="true" symbol="12" value="Shared Use Carriageway" label="Shared Use Carriageway"/>
      <category render="true" symbol="13" value="Restricted Local Access Road" label="Restricted Local Access Road"/>
      <category render="true" symbol="14" value="Guided Busway Carriageway" label="Guided Busway Carriageway"/>
    </categories>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Color" value="1~~1~~CASE WHEN   &quot;classification&quot;  =  'A Road' OR   &quot;classification&quot;  = 'A Road, Collapsed Dual Carriageway' THEN  color_rgb( 212,106,141) WHEN  &quot;classification&quot;  = 'B Road' OR  &quot;classification&quot; =  'B Road, Collapsed Dual Carriageway'  THEN  color_rgb( 212,158,114) WHEN  &quot;classification&quot;  =  'Motorway' OR  &quot;classification&quot;  =  'Motorway, Collapsed Dual Carriageway'  THEN  color_rgb( 54,177,201) WHEN &quot;classification&quot;  =  'Primary Road' OR  &quot;classification&quot;  =  'Primary Road, Collapsed Dual Carriageway'  THEN  color_rgb( 120,179,127) END~~"/>
    <property key="labeling/dataDefined/Size" value="1~~1~~CASE WHEN   &quot;classification&quot;  =  'A Road' OR   &quot;classification&quot;  = 'A Road, Collapsed Dual Carriageway' THEN  20 WHEN  &quot;classification&quot;  = 'B Road' OR  &quot;classification&quot; =  'B Road, Collapsed Dual Carriageway'  THEN  20 WHEN  &quot;classification&quot;  =  'Motorway' OR  &quot;classification&quot;  =  'Motorway, Collapsed Dual Carriageway'  THEN  20 WHEN &quot;classification&quot;  =  'Primary Road' OR  &quot;classification&quot;  =  'Primary Road, Collapsed Dual Carriageway'  THEN  20 END~~"/>
