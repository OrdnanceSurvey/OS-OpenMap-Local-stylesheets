...
<qgis version="2.16.1-Nødebo" simplifyAlgorithm="0" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="classifica" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="High Water Mark" label="High Water Mark"/>
      <category render="true" symbol="1" value="Low Water Mark" label="Low Water Mark"/>
    </categories>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE WHEN    &quot;CLASSIFICA&quot;    = 'High Water Mark'  THEN  'MHW' ELSE 'MLW' END"/>
    ...
    <property key="labeling/fontSize" value="25"/>
    ...
    <property key="labeling/minFeatureSize" value="99"/>
