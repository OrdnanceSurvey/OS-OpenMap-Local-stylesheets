...
<qgis version="2.16.1-Nødebo" simplifyAlgorithm="0" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="classifica" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="Multi Track" label="Multi Track"/>
      <category render="true" symbol="1" value="Narrow Gauge" label="Narrow Gauge"/>
      <category render="true" symbol="2" value="Single Track" label="Single Track"/>
    </categories>
    <symbols>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;CLASSIFICA&quot;" sortOrder="1">
    <columns>
