...
<qgis version="3.16.7-Hannover" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="1" simplifyDrawingHints="1" maxScale="2500" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyMaxScale="1" minScale="20001" readOnly="0">
  ...
  <renderer-v2 type="categorizedSymbol" attr="CLASSIFICA" enableorderby="0" forceraster="0" symbollevels="0">
    <categories>
      <category render="true" value="Multi Track" label="Multi Track" symbol="0"/>
      <category render="true" value="Narrow Gauge" label="Narrow Gauge" symbol="1"/>
      <category render="true" value="Single Track" label="Single Track" symbol="2"/>
    </categories>
    <symbols>
  ...
  <DiagramLayerSettings placement="2" linePlacementFlags="18" showAll="1" dist="0" priority="0" obstacle="0" zIndex="0">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
