...
**8.**  Your Table of Contents should now look like this. This is the recommended layer order: 
  ...
  ![Screenshot](https://github.com/OrdnanceSurvey/OS-OpenMap-Local-stylesheets/blob/master/ESRI%20Shapfile%20stylesheets/ESRI%20stylesheets%20(LYR)/Backdrop%20style/images/OML_BD_layer_order.png "Recommended layer order for OS Open Map Local")
