...
<qgis simplifyDrawingTol="1" labelsEnabled="1" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" minScale="1e+08" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyLocal="1" readOnly="0" version="3.4.1-Madeira" maxScale="-4.65661e-10">
  <flags>
  ...
  <renderer-v2 attr="siteTheme" enableorderby="0" symbollevels="0" forceraster="0" type="categorizedSymbol">
    ...
    <symbols>
      <symbol alpha="0.5" type="fill" name="0" clip_to_extent="1">
      ...
      <symbol alpha="0.5" type="fill" name="3" clip_to_extent="1">
        <layer enabled="1" locked="0" pass="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="siteTheme"/>
  </editable>
  <labelOnTop>
    ...
    <field labelOnTop="0" name="siteTheme"/>
  </labelOnTop>
  <widgets/>
