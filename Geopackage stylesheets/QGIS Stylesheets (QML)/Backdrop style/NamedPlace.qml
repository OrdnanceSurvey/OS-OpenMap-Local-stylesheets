...
<qgis readOnly="0" simplifyMaxScale="1" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" minScale="1e+08" simplifyDrawingTol="1" maxScale="0" simplifyAlgorithm="0" version="3.4.1-Madeira" styleCategories="AllStyleCategories" labelsEnabled="1">
  <flags>
  ...
  <labeling type="simple">
    <settings>
      <text-style fontSizeUnit="MapUnit" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" fontItalic="0" fontCapitals="0" blendMode="0" fieldName="distinctiveName" fontFamily="Arial" multilineHeight="1" previewBkgrdColor="#ffffff" useSubstitutions="0" fontSize="28" textColor="115,115,115,255" textOpacity="1" fontWeight="50" fontLetterSpacing="0" fontWordSpacing="0" isExpression="0" namedStyle="Regular">
      ...
      <placement centroidInside="0" placement="1" maxCurvedCharAngleOut="-20" repeatDistance="0" centroidWhole="0" xOffset="0" rotationAngle="0" repeatDistanceUnits="MM" distUnits="MM" offsetType="0" priority="10" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleIn="20" quadOffset="4" offsetUnits="MM" yOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" placementFlags="0" dist="0" preserveRotation="1"/>
      <rendering scaleMax="10000000" scaleMin="1" drawLabels="1" upsidedownLabels="0" obstacleType="0" scaleVisibility="0" fontLimitPixelSize="1" obstacleFactor="1" mergeLines="0" displayAll="0" labelPerPart="0" zIndex="0" minFeatureSize="0" maxNumLabels="2000" limitNumLabels="0" fontMaxPixelSize="10000" obstacle="1" fontMinPixelSize="3"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
  ...
  <constraints>
    ...
    <constraint field="distinctiveName" constraints="1" notnull_strength="1" exp_strength="0" unique_strength="0"/>
    <constraint field="classification" constraints="1" notnull_strength="1" exp_strength="0" unique_strength="0"/>
    <constraint field="fontHeight" constraints="1" notnull_strength="1" exp_strength="0" unique_strength="0"/>
    <constraint field="textOrientation" constraints="1" notnull_strength="1" exp_strength="0" unique_strength="0"/>
    <constraint field="textOrientation_uom" constraints="1" notnull_strength="1" exp_strength="0" unique_strength="0"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="fontHeight"/>
      <column hidden="0" type="field" width="-1" name="textOrientation"/>
      <column hidden="0" type="field" width="-1" name="textOrientation_uom"/>
