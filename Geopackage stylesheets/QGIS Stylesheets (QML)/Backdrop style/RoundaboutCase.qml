...
<qgis readOnly="0" simplifyMaxScale="1" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" minScale="1e+08" simplifyDrawingTol="1" maxScale="100000" simplifyAlgorithm="0" version="3.4.1-Madeira" styleCategories="AllStyleCategories" labelsEnabled="0">
  ...
  <renderer-v2 type="categorizedSymbol" forceraster="0" attr="classification" symbollevels="0" enableorderby="0">
    <categories>
      <category symbol="0" value="A Road" label="A Road" render="true"/>
      <category symbol="1" value="B Road" label="B Road" render="true"/>
      <category symbol="2" value="Local Road" label="Local Road" render="true"/>
      <category symbol="3" value="Minor Road" label="Minor Road" render="true"/>
      <category symbol="4" value="Primary Road" label="Primary Road" render="true"/>
      <category symbol="5" value="Restricted Local Access Road" label="Restricted Local Access Road" render="true"/>
    </categories>
    <symbols>
