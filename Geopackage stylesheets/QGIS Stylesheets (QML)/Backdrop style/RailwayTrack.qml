...
<qgis readOnly="0" simplifyMaxScale="1" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" minScale="1e+08" simplifyDrawingTol="1" maxScale="-4.65661e-10" simplifyAlgorithm="0" version="3.4.1-Madeira" styleCategories="AllStyleCategories" labelsEnabled="0">
  ...
  <renderer-v2 type="categorizedSymbol" forceraster="0" attr="classification" symbollevels="0" enableorderby="0">
    <categories>
      <category symbol="0" value="Multi Track" label="Multi Track" render="true"/>
      <category symbol="1" value="Narrow Gauge" label="Narrow Gauge" render="true"/>
      <category symbol="2" value="Single Track" label="Single Track" render="true"/>
    </categories>
    <symbols>
